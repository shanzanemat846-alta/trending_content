...
export const _testimonials = [
  ...
  },
  {
    ...
    content: `It's a very good dashboard and we are really liking this tool . We've done many posts, , to fit our job methodology but the post is one of the best in terms of content and style. The team did a really good job.`,
  },
  {
    ...
    content: `Trending Content is realy fast and helpful the making  trending post is looks amazing also the tool is very excellent and user friendly realy good job !`,
  },
  {
    ...
    content: `Amazing, really good post quality and gives you a lot of examples for contents.`,
  },
  {
    ...
    content: `Got a few questions after entering the tool. The owner responded very fast and very helpfull. Overall the service is excellent and works very good. 5/5 stars!`,
  },
  {
    ...
    content: `CEO of Codealy.io here. We’ve built many posts that makes sense - posts are based on social medias and run in chatGPT. We automate the pain points - storing images, running it and sharing post results with the people, remotely. Entering this tool as we need to provide an awesome dashboard for our early customers. I am super happy with purchase. The tool is just as good as the user-friendly. Thanks!`,
  },
];
