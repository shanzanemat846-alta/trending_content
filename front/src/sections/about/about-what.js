...
export const SKILLS = [...Array(3)].map((_, index) => ({
  label: ['Twitter', 'People also ask', 'Reddit'][index],
      ...
      <Grid container columnSpacing={{ md: 3 }} alignItems="flex-start">
        ...
        <Grid xs={12} md={6} lg={5}>
          ...
          <m.div variants={varFade().inRight}>
            ...
            >
              Our site is the most advanced and user-friendly tool you will find on the market, we
              have documentation and video to help set your post making really easily, pre-prompted data
              you can import in reddit and everything from the tools options to page content can
              be edited from the chatGPT. This is the tool you are looking for.
            </Typography>
          </m.div>
